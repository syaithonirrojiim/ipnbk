...
<div class="row">
 ...
 ?>
			...
			<div class="card-body">
				<h4 class="card-title" align="center">Edit Data Pegawai" </h4>
				<p class="card-text"></p>
				<br /><br />
				<div class="row">
				<div class="col-2"></div>
				...
				<form action="<?php echo base_url(). 'unit_kerja/update'; ?>" method="post">
  <div class="form-group row">
    ...
    <div class="col-7">
      ...
      <input id="nip" name="nip" type="text" required class="form-control here" value="<?php echo $u->nip ?>">
    </div>
  </div>
  <div class="form-group row">
