...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: #e3f2fd;">
  <a class="navbar-brand" href="#">
    <img src="../../assets/bootstrap/img/logos.png" width="30" height="30" class="d-inline-block align-top" alt="">
    BBIB-SINGOSARI
  </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item"> <a class="nav-link" href="<?php echo base_url().'page'?>"><img src="../../assets/bootstrap/img/home.png" /> HOME <span class="sr-only">(current)</span></a> </li>
