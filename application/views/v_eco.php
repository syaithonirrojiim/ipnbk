...
<html>
<head>
<title>EDIT DATA ADMIN/CO</title>
...
<div class="row">
 ...
 ?>
			...
			<div class="card-body">
				<h4 class="card-title" align="center">Edit Data Admin/Co" </h4>
				<p class="card-text"></p>
				<br /><br />
				<div class="row">
				<div class="col-2"></div>
				...
				<form action="<?php echo base_url(). 'co_admin/update'; ?>" method="post">
  <div class="form-group row">
    ...
    <div class="col-7">
      ...
      <input id="nip" name="id_admin" type="text" required class="form-control here" value="<?php echo $u->id_admin ?>">
    </div>
  </div>
  <div class="form-group row">
    <label for="nama" class="col-5 col-form-label">Nama Lengkap</label> 
    <div class="col-7">
      <input id="nama" name="nama" type="text" required class="form-control here" value="<?php echo $u->nama ?>">
    </div>
  </div>
  <div class="form-group row">
