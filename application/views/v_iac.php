...
<div class="row">
  ...
  <a href="<?php echo base_url().'page/co_admin'?>" class="list-group-item list-group-item-action">Lihat Data Admin/Co</a>
  <a href="#" class="list-group-item list-group-item-action active">Tambah data baru Admin/Co</a>
 ...
 ?>
			...
			<div class="card-body">
				<h4 class="card-title" align="center">Input Data Baru Admin/Co</h4>
				<p class="card-text"></p>
				<br /><br />
				<div class="row">
				<div class="col-2"></div>
				...
				<form action="<?php echo base_url(). 'co_admin/tambah_aksi'; ?>" method="post">
  <div class="form-group row">
    <label for="nip" class="col-5 col-form-label">Username</label> 
    <div class="col-7">
      <input id="id_admin" name="id_admin" type="text" required class="form-control here">
    </div>
  </div>
  <div class="form-group row">
    <label for="nama" class="col-5 col-form-label">Nama Admin/Co</label> 
    <div class="col-7">
  ...
  <div class="form-group row">
    ...
    <div class="col-7">
      <input id="pass" name="pass" type="text" required class="form-control here">
    </div>
  </div>
  <div class="form-group row">
    <label for="level" class="col-5 col-form-label">Level Hak Akses</label> 
    <div class="col-7">
