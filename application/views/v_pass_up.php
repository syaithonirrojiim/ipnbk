...
<div class="row">
 ...
 ?>
			...
			<div class="card-body">
				...
				<form action="<?php echo base_url(). 'unit_kerja/pass'; ?>" method="post">
  <div class="form-group row">
    ...
    <div class="col-7">
      ...
      <input readonly="readonly" id="nip" name="nip" type="text" required class="form-control here" value="<?php echo $u->nip ?>">
    </div>
  </div>
  <div class="form-group row">
